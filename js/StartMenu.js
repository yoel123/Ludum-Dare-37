...
yengine.StartMenu.prototype = {
	...
	create: function () {
		...
		startBG = this.add.image(this.world.centerX/2.5, this.world.centerY/2, 'titleimage');
		startBG.inputEnabled = true;
		startBG.events.onInputDown.addOnce(this.startGame, this);
		
		startPrompt = this.add.bitmapText(this.world.centerX/2.5-30, this.world.centerY+180, 'eightbitwonder', 'Touch to Start!', 24);
